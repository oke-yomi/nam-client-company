  ...
  return (
    <div className="bg-nam-gray">
      <div className="max-w-screen-xxl w-full mx-auto h-screen bg-image overflow-hidden">
        <div className="w-full h-full lg:py-12 py-7 px-6 lg:px-12">
          <div className="mx-auto h-full">
            <div className="w-full flex justify-between items-center mb-5 lg:mb-0">
              <Image
                src={"/logo.svg"}
                alt={""}
                width={74}
            ...
            <div className="w-full h-[90%] lg:h-[85%]">
              <div className="w-full max-w-[560px] mx-auto h-full lg:shadow-custom-shadow lg:rounded-2xl">
                <div className="overflow-y-scroll no-scrollbar w-full h-full lg:px-12 lg:py-12">
                  {children}
                </div>
              </div>
            </div>
